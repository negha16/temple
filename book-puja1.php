...
<!-- custom styling -->
<link rel="stylesheet" type="text/css" href="css/book-puja963.css" />
...
<div class="container ">           
  <div class="row">
    <div class="col-lg-12 form_sec_outer_task border">
     <div class=" form_field_outer">
          <div class="row form_field_outer_row">
            <div class="form-group col-sm-3">
                      <label for="PUJA_CODEb_no_1">Pooja</label>
                      <input form="bookingform" class="form-select"list="puja" name="PUJA_CODEb_no[]"id="PUJA_CODEb_no_1" />
                        <datalist id="puja">
               ...
               <div class="form-group col-sm-3">
                    ...
                    <input form="bookingform" type="date" class="form-control" name="DATE_REQDb_no[]" id="DATE_REQDb_no_1" required>
                                    ...
                                    <div  form="boxform"class="form-group col-sm-3 mb-3" id="box">
                                            ...
                                            <input form="boxform" type="date" name="DATE_REQDb_no[]"class="form-control" id="DATE_FROMb_no_1" onblur="date1();">
                                                ...
                                                <input form="boxform" type="date" class="form-control" id="DATE_TOb_no_1" onblur="date2();">
                                                  <input form="boxform"type="checkbox" id="dailyb_no_1" name="dailyb_no[]">
                                                    ...
                                                    <button form="boxform" class="w3-button w3-yellow" id="okb_no_1">ok</button>
                                                    </div>              
                                                </div>
            <div class="form-group col-sm-3">
            <label for="PUJA_WHOM_b_no_1">Devotee name</label>
               ...
               <div class="form-group col-sm-3">
                <label for="STAR_CODEb_no_1">Birth Star</label>
                      <input form="bookingform" class="form-select"list="star" name="star"id="STAR_CODEb_no_1" />
                        <datalist id="star">
                          <option value="pooram">
                          <option value="moolam">
              ...
              <label for="PRSD_NEEDb_no_1">Prasada courier</label>
                    <select form="bookingform" name="STAR_CODEb_no[]"id="PRSD_NEEDb_no_1" class="form-select">
                        <option>yes</option>
                        <option>no</option>
                    </select required>
            </div>
          ...
          <label for="PUJA_RATEb_no_1">Price</label>
                    <input form="bookingform" type="number"name="PUJA_RATEb_no[]" class="form-control" id="PUJA_RATEb_no_1">
            </div>
            <div class="form-group col-sm-3 add_del_btn_outer"><br>
              <a class="btn_round add_node_btn_frm_field" title="Copy or clone this row">
                <i class="fas fa-copy" ></i>
              </a>

              <a class="btn_round  remove_node_btn_frm_field" disabled>
...
<br>
  ...
  <a href="javascript:void(0);" onclick="javascript:dakshina();">Would you like to give dakshina?</a>
                  <div class="dakshina">
                    <label for="DKSN_PRST">Amount for Dakshina</label>
                <input form="bookingform" name="DKSN_PRST" id="DKSN_PRST"type="text" maxlength="4"  pattern="[0-9]{4}" title="Enter your mobile number" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"/>
                 </div>
                  <button class="btn btn-outline-lite py-0 add_new_frm_field_btn"><i class="fas fa-plus add_icon"></i> Add new form</button>
                  <button type="button" class="btn btn-success " type="submit" style="float :right;margin-right: 5%;"><i class="fas fa-cart-plus"> Add to Cart</i></button> 
        ...
        $(".form_field_outer").append(`
          <div class="row form_field_outer_row">
            <div class="form-group col-sm-3">
                      ...
                      <input form="bookingform" class="form-select"list="puja" name="PUJA_CODEb_no[]"id="PUJA_CODEb_no_${index}" />
                        <datalist id="puja">
                          <option value="vilak"></option>
                          <option value="pushpanjali"></option>
                          <option value="dhara "></option>
               ...
               <div class="form-group col-sm-3">
                    ...
                    <input form="bookingform" type="date" class="form-control" name="DATE_REQDb_no[]" id="DATE_REQDb_no_${index}" required>
                                    ...
                                    <div class="form-group col-sm-3 mb-3" id="box">
                                        <label>To schedule(optional)</label><br>
                                         <span id="Schedule" onclick="schedulePooja(this)"><button class="btn btn-primary">Schedule Pooja</button></span>
                                          <div class="schedule-form" id="schedule-form">
            ...
            <label for="PUJA_WHOM_b_no_${index}">Devotee name</label>
               ...
               <div class="form-group col-sm-3">
                <label for="STAR_CODEb_no_${index}">Birth Star</label>
                      <input form="bookingform" class="form-select"list="star" name="star"id="STAR_CODEb_no_${index}" />
                        <datalist id="star">
                          <option value="pooram">
                          <option value="moolam">
                          <option value="makeeram">
          ...
          <label for="PUJA_RATEb_no_${index}">Price</label>
                    <input form="bookingform" type="number"name="PUJA_RATEb_no[]" class="form-control" id="PUJA_RATEb_no_${index}">
            </div>
            <div class="form-group col-sm-3 add_del_btn_outer"><br>
